...
public class Procesos {
    ...
    private void imprimirInformacion() {
        ...
        menuImprimir += "1. Mostrar Pacientes\n";
        menuImprimir += "2. Mostrar Empleados Eventuales\n";
        menuImprimir += "3. Mostrar Empleados Por Planilla\n";
        menuImprimir += "4. Mostrar Medicos\n";
        menuImprimir += "5. Mostrar citas programadas\n";
